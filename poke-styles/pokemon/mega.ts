...
addStyles(megas, (p, i) => ".mega .dexEntry .pokesprite." + dexClean(p) + " img, .pokesprite.mega." + dexClean(p) + " img { background-image:url('../img/pokemon-mega-large.png')!important; background-position: 0px -" + i + "em!important; }");

addStyles(megas, (p, i) => ".mega .shiny .dexEntry .pokesprite." + dexClean(p) + " img, .pokesprite.mega.shiny." + dexClean(p) + " img { background-image:url('../img/pokemon-mega-large-shiny.png')!important; background-position: 0px -" + i + "em!important; }");