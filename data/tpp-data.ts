...
var Season9: TPP.Collection = {
    Name: "Season 9",
    Scale: TPP.Scale.Days,
    Runs: []
};
var Season10: TPP.Collection = {
    Name: "Season 10",
    Scale: TPP.Scale.Days,
    Runs: []
};
...
var Season12: TPP.Collection = {
    Name: "Season 12",
    Scale: TPP.Scale.Days,
    Runs: []
};
var Season13: TPP.Collection = {
    Name: "Season 13",
    Scale: TPP.Scale.Days,
    Runs: []
};
...
var tppData: TPP.Collection[] = [Season1, Season2, Season3, Season4, Season5, Season6, Season7, Season8, Season9, Season10, Season11, Season12, Season13, Sidegames, QuickSidegames, Revisits, LongIntermissions, Intermissions, ShortIntermissions];
